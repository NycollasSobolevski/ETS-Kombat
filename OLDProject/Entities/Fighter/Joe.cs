...
public class Joe : Fighter
{
    ...
    public override void Draw(Graphics g)
    {
        ...
        g.DrawString($"Is Hit: {this.isCollide(
            this.Frame.HitBox, this.Enemy.Frame.HurtBox
        )}", new Font("Arial", 12), Brushes.Black, new PointF(10,30));
    ...
    private void setHurtboxes()
    {
        ...
        //*idle*
        hurtboxes = new RectangleF[] {
            new RectangleF(0, 0, (65 * 2), (103 * 2)),
            new RectangleF(0, 0, (65 * 2), (103 * 2)),
            new RectangleF(0, 0, (65 * 2), (103 * 2)),
            new RectangleF(0, 0, (65 * 2), (103 * 2)),
            new RectangleF(0, 0, (65 * 2), (103 * 2)),
    ...
    private void setPushboxes()
    {
        //*Forward / Backward*
        var hurtboxes = new RectangleF[] {
            new RectangleF(0, 0, (66 * 2), (106 * 2)),
            new RectangleF(0, 0, (66 * 2), (105 * 2)),
            new RectangleF(0, 0, (66 * 2), (118 * 2)),
            new RectangleF(0, 0, (66 * 2), (105 * 2)),
            new RectangleF(0, 0, (66 * 2), (105 * 2)),
        };
        for (int i = 0; i < Frames[States.Idle].Count; i++)
