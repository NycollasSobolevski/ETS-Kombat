...
public class Player
{
    ...
    public Player(Fighter fighter, string name)
    {
        Fighter = fighter;
        Name = name;
    }
...
{
    public Player1(Fighter fighter, string name) : base(fighter, name)
    {
    }
}
...
{
    public Player2(Fighter fighter, string name) : base(fighter, name)
    {
    }
}